...
<?php $__env->startSection('title', 'ثبت پروژه مهندسی'); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="projectForm" action="<?php echo e(route('user.projects.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row g-3" id="domains-list">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="card border domain-card" data-domain-id="<?php echo e($domain->id); ?>">
                                            <div class="card-body">
                                                <div class="form-check">
                                                    <input class="form-check-input domain-checkbox" type="checkbox" 
                                                        id="domain_<?php echo e($domain->id); ?>" 
                                                        value="<?php echo e($domain->id); ?>"
                                                        data-processes='<?php echo json_encode($domain->processes, 15, 512) ?>'>
                                                    <label class="form-check-label fw-medium" for="domain_<?php echo e($domain->id); ?>">
                        ...
                        <div class="d-flex justify-content-end gap-2 ep-form-actions">
                            <a href="<?php echo e(route('user.projects.index')); ?>" class="btn btn-light">انصراف</a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/engipi/laravel_app/resources/views/user/projects/create.blade.php ENDPATH**/ ?>