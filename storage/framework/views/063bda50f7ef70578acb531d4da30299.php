...
<div class="ep-wrap">
    ...
    <div class="ep-form">
        ...
        <?php if(session('status')): ?>
            <div class="ep-alert-ok"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="ep-alert-err"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
            ...
            <div class="ep-field">
                ...
                <div class="ep-input-box">
                    ...
                    <input
                        ...
                        id="login"
                        name="login"
                        class="ep-inp <?php $__errorArgs = ['login'];
...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="ep-remember" style="justify-content: space-between;">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="ep-forgot" style="color:#00d4aa;">فراموش کردید؟</a>
            </div>
        ...
        <p class="ep-signup">
            حساب کاربری ندارید؟&nbsp;
            <a href="<?php echo e(route('register')); ?>">ثبت‌نام رایگان</a>
        </p>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/engipi/laravel_app/resources/views/auth/login.blade.php ENDPATH**/ ?>