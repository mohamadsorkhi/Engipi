...
<?php $__env->startSection('title', 'انتخاب نقش'); ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 d-flex">
                ...
                <?php if($hasEmployer): ?>
                    ...
                    <form action="<?php echo e(route('profile.activate')); ?>" method="POST"
                ...
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-md-6">
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('profiles.update', $employerProfile)); ?>" method="POST">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <div class="mb-3">
                                        <label class="form-label">نام شرکت (اختیاری)</label>
                                        <input type="text" name="company_name" class="form-control"
                                               value="<?php echo e($employerProfile->company_name); ?>" maxlength="255">
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('profiles.update', $specialistProfile)); ?>" method="POST">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <div class="mb-3">
                                        <label class="form-label">عنوان تخصصی <span class="text-danger">*</span></label>
                                        <input type="text" name="headline" class="form-control"
                                               value="<?php echo e($specialistProfile->headline); ?>"
                                               required minlength="2" maxlength="255">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">بیوگرافی (اختیاری)</label>
                                        <textarea name="bio" class="form-control"
                                                  rows="3"><?php echo e($specialistProfile->bio); ?></textarea>
                                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/engipi/laravel_app/resources/views/user/profile-select.blade.php ENDPATH**/ ?>