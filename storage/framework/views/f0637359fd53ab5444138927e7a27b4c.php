    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav mx-auto gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white fw-medium" href="<?php echo e(route('about')); ?>">درباره ما</a>
                </li>
            </ul>

            <div class="d-flex align-items-center gap-2 mt-3 mt-lg-0">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-cta-primary btn-sm px-3">
                        <i class="ri-dashboard-line me-1"></i>داشبورد
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-white fw-medium text-decoration-none px-2">ورود</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-nav-outline">ثبت‌نام رایگان</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-3 mb-5 hero-cta">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-cta-primary">
                        <i class="ri-add-circle-line me-2"></i>ثبت پروژه
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-cta-outline">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="tabEmployer" role="tabpanel">
                <div class="row g-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $empSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4">
                        <div class="step-card text-center">
                            <div class="step-num"><?php echo e($step['num']); ?></div>
                            <div class="step-icon-wrap" style="background: <?php echo e($step['bg']); ?>;">
                                <i class="<?php echo e($step['icon']); ?>" style="color: <?php echo e($step['ic']); ?>;"></i>
                            </div>
                            <h5 class="fw-bold mb-2"><?php echo e($step['title']); ?></h5>
                            <p class="text-muted mb-0 small"><?php echo e($step['body']); ?></p>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="tabSpecialist" role="tabpanel">
                <div class="row g-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $spSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4">
                        <div class="step-card text-center">
                            <div class="step-num"><?php echo e($step['num']); ?></div>
                            <div class="step-icon-wrap" style="background: <?php echo e($step['bg']); ?>;">
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="domain-card">
                    <div class="domain-icon" style="background: <?php echo e($d['bg']); ?>;">
                        <i class="<?php echo e($d['icon']); ?>" style="color: <?php echo e($d['ic']); ?>;"></i>
                    </div>
                    <h6 class="fw-bold mb-1"><?php echo e($d['name']); ?></h6>
                    <small class="text-muted"><?php echo e($d['sub']); ?></small>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="feature-card">
                    <div class="feat-icon" style="background: <?php echo e($f['bg']); ?>;">
                        <i class="<?php echo e($f['icon']); ?>" style="color: <?php echo e($f['ic']); ?>;"></i>
                    </div>
                    <h6 class="fw-bold mb-2"><?php echo e($f['title']); ?></h6>
                    <p class="text-muted small mb-0"><?php echo e($f['body']); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="testi-card">
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.8;"><?php echo e($t['text']); ?></p>
                    <div class="d-flex align-items-center gap-3">
                        <div class="testi-avatar" style="background: <?php echo e($t['clr']); ?>;"><?php echo e($t['initial']); ?></div>
                        <div>
                            <div class="fw-bold small"><?php echo e($t['name']); ?></div>
                            <div class="text-muted" style="font-size: 0.78rem;"><?php echo e($t['role']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="cta-banner text-white text-center p-5">
            ...
            <div class="d-flex flex-wrap gap-3 justify-content-center">
                <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg rounded-pill px-5 fw-bold" style="color: var(--clr-primary);">
                    <i class="ri-add-circle-line me-2"></i>ثبت پروژه مهندسی
                </a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light btn-lg rounded-pill px-5 fw-bold">
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-2 offset-lg-2">
                ...
                <ul class="list-unstyled" style="font-size: 0.88rem;">
                    <li class="mb-2"><a href="<?php echo e(route('about')); ?>">درباره ما</a></li>
                    <li class="mb-2"><a href="<?php echo e(route('terms')); ?>">قوانین و مقررات</a></li>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                ...
                <ul class="list-unstyled" style="font-size: 0.88rem;">
                    <li class="mb-2"><a href="<?php echo e(route('register')); ?>">ثبت پروژه</a></li>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                ...
                <ul class="list-unstyled" style="font-size: 0.88rem;">
                    <li class="mb-2"><a href="<?php echo e(route('register')); ?>">ثبت‌نام</a></li>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2" style="font-size: 0.83rem;">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="<?php echo e(route('terms')); ?>">حریم خصوصی</a>
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH /home/engipi/laravel_app/resources/views/landing.blade.php ENDPATH**/ ?>