                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="my-3 text-center">
                            <p class="mb-1"><a href="<?php echo e(route('login')); ?>"
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/engipi/laravel_app/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>