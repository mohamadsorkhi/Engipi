...
<head>
    ...
    @include('layouts.social-meta', ['metaTitle' => 'خط مشی و قوانین استفاده | EngiPi'])
...
<section class="page-hero text-white text-center">
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <h1 style="font-size: clamp(1.8rem, 4vw, 2.8rem); font-weight: 900; margin: 0.8rem 0 1rem;">
            قوانین استفاده از <span style="color: var(--clr-accent);">EngiPi</span>
        </h1>
        <p style="font-size: 1rem; opacity: 0.82; max-width: 520px; margin: 0 auto 1.5rem; line-height: 1.85;">
            لطفاً پیش از استفاده از خدمات EngiPi، این قوانین را با دقت مطالعه کنید
        </p>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-9">
            ...
            <div class="terms-section" id="general">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="text-muted small mt-1 mb-0">شرایط پایه‌ای برای استفاده از پلتفرم EngiPi</p>
                    </div>
                </div>
                <ul class="terms-list mt-3">
                    <li>استفاده از EngiPi به معنای پذیرش کامل تمامی قوانین و مقررات این پلتفرم است.</li>
                    <li>حداقل سن مجاز برای ثبت‌نام و استفاده از خدمات EngiPi ۱۸ سال تمام است.</li>
                    ...
                    <li>EngiPi این حق را دارد که در صورت نقض قوانین، حساب کاربری را تعلیق یا حذف کند.</li>
            ...
            <div class="terms-section" id="privacy">
                ...
                <ul class="terms-list mt-3">
                    <li>EngiPi اطلاعات شخصی کاربران را تنها برای بهبود تجربه کاربری و اجرای خدمات پلتفرم جمع‌آوری می‌کند.</li>
                    <li>اطلاعات شخصی کاربران بدون رضایت صریح آن‌ها به اشخاص ثالث فروخته یا منتقل نخواهد شد.</li>
                    <li>EngiPi از پروتکل‌های امنیتی استاندارد برای حفاظت از داده‌های کاربران استفاده می‌کند.</li>
                    ...
                    <li>EngiPi ممکن است از کوکی‌ها برای بهبود تجربه کاربری استفاده کند.</li>
                </ul>
            </div>
            ...
            <div class="terms-section" id="services">
                ...
                <ul class="terms-list mt-3">
                    <li><strong>در حال حاضر تمامی خدمات EngiPi به صورت کاملاً رایگان ارائه می‌شوند.</strong> استفاده از پلتفرم برای ثبت پروژه، جستجوی متخصص و ارسال درخواست هیچ هزینه‌ای ندارد.</li>
                    <li>EngiPi این حق را محفوظ می‌دارد که در آینده برای برخی خدمات پیشرفته تعرفه تعیین کند؛ در این صورت با اطلاع‌رسانی قبلی به کاربران اعمال خواهد شد.</li>
                    <li>پلتفرم EngiPi در مراحل اولیه MVP قرار دارد و ممکن است برخی قابلیت‌ها در حال توسعه باشند.</li>
                    <li>EngiPi خدمات پرداخت آنلاین یا ضمانت تراکنش مالی بین کارفرما و متخصص ارائه نمی‌دهد — توافق مالی مستقیماً بین دو طرف انجام می‌شود.</li>
                    <li>EngiPi مسئولیتی در قبال کیفیت یا نتیجه همکاری بین کارفرما و متخصص ندارد و صرفاً بستر اتصال را فراهم می‌کند.</li>
                </ul>
            </div>
            ...
            <div class="terms-section" id="employer">
                ...
                <ul class="terms-list mt-3">
                    ...
                    <li>کارفرما نباید اطلاعات دریافت‌شده از پلتفرم را برای دور زدن سیستم EngiPi به کار برد.</li>
                </ul>
            </div>
            ...
            <div class="terms-section" id="dispute">
                ...
                <ul class="terms-list mt-3">
                    ...
                    <li>در صورتی که اختلاف از طریق مذاکره مستقیم حل نشود، می‌توانید موضوع را از طریق سیستم تیکت EngiPi به تیم پشتیبانی گزارش دهید.</li>
                    <li>EngiPi در اختلافات مالی بین کاربران مداخله نمی‌کند و مسئولیت حل این دسته از اختلافات بر عهده طرفین است.</li>
                    <li>در صورت گزارش تخلف آشکار از قوانین پلتفرم، تیم EngiPi ممکن است حساب کاربری را تعلیق کند.</li>
            ...
            <div class="terms-section" id="changes">
                ...
                <ul class="terms-list mt-3">
                    <li>EngiPi این حق را دارد که قوانین و مقررات را در هر زمان به‌روز کند.</li>
