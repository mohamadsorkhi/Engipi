...
.bp-auth-back { text-align: center; font-size: 0.83rem; color: var(--bp-muted); margin: 0; }
.bp-auth-back a { color: var(--bp-blue); font-weight: 700; text-decoration: none; transition: color 0.2s; }
...
.bp-auth-bar { flex: 1; border-radius: 3px 3px 0 0; min-height: 6px; background: var(--bp-blue-l); }
...
<div class="bp-auth-wrap">
    ...
    <div class="bp-auth-form">
        ...
        <h2 class="bp-auth-heading">فراموشی رمز عبور</h2>
        <p class="bp-auth-subhead">ایمیل خود را وارد کنید تا لینک بازنشانی برایتان ارسال شود</p>
        ...
        <form action="{{ route('password.email') }}" method="POST">
            ...
            <div class="bp-auth-field">
                <label class="bp-auth-label" for="email">ایمیل</label>
            ...
            <button type="submit" class="bp-btn bp-btn--primary" style="width:100%; justify-content:center; margin-bottom:1.4rem;">
