...
│       ├── create.blade.php
│       └── show.blade.php
├── public/vendor/engipi/   ← CSS و فونت‌ها
...
- محتوای `public/vendor/engipi/` را در `public/vendor/engipi/` پروژه‌ات کپی کن.
...
```php
Route::get('/dashboard', [DashboardController::class, 'index'])->name('engipi.dashboard');
```
