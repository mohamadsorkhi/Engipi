...
@section('title', "Engipi — مارکت‌پلیس تخصصی پروژه‌های مهندسی")
...
<footer class="footer">
  <div class="bp-container">
    <div class="fgrid2">
      ...
      <div><h6>Engipi</h6><ul><li><a href="#">درباره ما</a></li><li><a href="#">قوانین</a></li><li><a href="#">تماس</a></li><li><a href="#">وبلاگ</a></li></ul></div>
