...
@section('title', "Engipi — ورود / ثبت‌نام")
...
<div class="auth">
  <aside class="auth-aside">
    ...
    <div class="auth-feat">
      ...
      <div class="f"><div class="ic"><i class="ri-shield-keyhole-line"></i></div><div><div class="t">پرداخت امن</div><div class="s">وجه تا تأیید نهایی نزد Engipi می‌ماند</div></div></div>
    ...
    <div class="foot">© ۱۴۰۴ Engipi — ساخته‌شده برای جامعه مهندسی ایران</div>
  </aside>
