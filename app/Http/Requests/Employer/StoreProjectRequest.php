...
class StoreProjectRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'skills.*.id.required' => 'شناسه مهارت الزامی است.',
            'skills.*.id.uuid' => 'شناسه مهارت معتبر نیست.',
            'skills.*.id.exists' => 'مهارت انتخاب شده یافت نشد.',
            'skills.*.level.required' => 'سطح مهارت برای هر مهارت میدانی الزامی است.',
            'skills.*.years_of_experience.required' => 'سال‌های تجربه برای هر مهارت میدانی الزامی است.',
            'skills.*.years_of_experience.integer' => 'سال‌های تجربه باید عدد صحیح باشد.',
